...
var popWin = {
    ...
    showWin: function(width, height, title, src) {
        var iframeHeight = height - 0;
        var marginLeft = width / 2;
        var marginTop = height / 2;
        var inntHtml = '';
        inntHtml += '<div id="mask" style="width:100%; height:100%;overflow:auto; position:fixed; top:0; left:0; z-index:1999;background:#000; filter:alpha(opacity=60); -moz-opacity:0.6; -khtml-opacity: 0.6; opacity:0.6;"></div>'
